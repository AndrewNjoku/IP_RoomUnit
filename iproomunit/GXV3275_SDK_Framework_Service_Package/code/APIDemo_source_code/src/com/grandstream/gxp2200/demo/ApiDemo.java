...
public class ApiDemo extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		ApiDemoApplication.initKeyInputPreference(getApplicationContext());
		initButtonMap();
		initButton();
	}
	...
	private void initButtonMap() {
		...
		mButtonSparseArray.put(R.id.btn_audiochanneldemo, AudioChannelDemo.class);
		mButtonSparseArray.put(R.id.btn_callstatus, CallStatusDemo.class);
		mButtonSparseArray.put(R.id.btn_keyinputdemo, KeyInputDemo.class);
		mButtonSparseArray.put(R.id.btn_leddemo_code, LedDemo.class);
	}
